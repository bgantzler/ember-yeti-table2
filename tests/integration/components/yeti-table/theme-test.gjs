...
module('Integration | Component | yeti-table (theme)', function (hooks) {
  ...
  test('renders table with correct theme (head)', async function (assert) {
    ...
    assert
      .dom('tfoot > tr > td > div')
      .hasClass(DEFAULT_THEME.pagination.controls);
    assert
      .dom('tfoot > tr > td > div > :nth-child(1)')
      .hasClass(DEFAULT_THEME.pagination.info);
    assert
      .dom('tfoot > tr > td > div > :nth-child(2)')
      .hasClass(DEFAULT_THEME.pagination.pageSize);
    assert
      .dom('tfoot > tr > td > div > :nth-child(3)')
      .hasClass(DEFAULT_THEME.pagination.previous);
    assert
      .dom('tfoot > tr > td > div > :nth-child(4)')
      .hasClass(DEFAULT_THEME.pagination.next);
  });
  ...
  test('deep merge of themes works', async function (assert) {
    ...
    assert
      .dom('tfoot > tr > td > div > button:nth-last-child(2)')
      .hasClass(DEFAULT_THEME.pagination.previous);
    assert
