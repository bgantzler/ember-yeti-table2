...
module('Integration | Component | yeti-table (sorting)', function (hooks) {
  ...
  test('updating sort property works', async function (assert) {
    ...
    await render(
      ...
      <YetiTable @data={{data}} as |table|>
        ...
        <table.header as |header|>
          <header.column @prop="firstName" @sort={{testParams.firstNameSort}} @onSortChanged={{mut testParams.firstNameSort}}>
            First name
          </header.column>
          <header.column @prop="lastName" @sort={{testParams.lastNameSort}} @onSortChanged={{mut testParams.firstNameSort}}>
            Last name
          </header.column>
          <header.column @prop="points">
            Points
  ...
  test('updating sort direction works', async function (assert) {
    ...
    await render(
      ...
      <YetiTable @data={{data}} as |table|>
        ...
        <table.header as |header|>
          <header.column @prop="firstName" @sort={{testParams.sort}} @onSortChanged={{mut testParams.sort}}>
            First name
          </header.column>
          <header.column @prop="lastName">
            Last name
  ...
  skip('changing a sorted property updates sorting is ignored correctly', async function (assert) {
    await render(
        <template>
      <YetiTable @data={{data}} @ignoreDataChanges={{true}} as |table|>
  ...
  test('sortFunction function works', async function (assert) {
    ...
    await render(
        <template>
      <YetiTable @data={{data}} @sortFunction={{customSort}} as |table|>
