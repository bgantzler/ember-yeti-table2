...
//       target,
//       key,
//       descriptorForField(target, key, undefined, options),
//     );
//   };
// };
//
...
// }
//
// function descriptorForField(_target, key, desc, options) {
...
//
//     get() {
//       return this.args[onChangedProperty]
//         ? this.args[key]
//         : options.updatable
//         ? savedValue.current ?? this.args[key]
//         : this.args[key];
